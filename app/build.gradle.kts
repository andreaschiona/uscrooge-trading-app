...
dependencies {
    ...
    // Compose
    implementation(enforcedPlatform("androidx.compose:compose-bom:2026.05.01"))
    ...
    androidTestImplementation(enforcedPlatform("androidx.compose:compose-bom:2026.05.01"))
